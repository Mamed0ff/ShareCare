...
public class LoggingAspect {
    ...
    @Pointcut("execution(* az.rentall.mvp.service.*.*(..))")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable{
        ...
        startLogAction(className,methodName,signature.getParameterNames(),point.getArgs());
    ...
    private void startLogAction(String className , String methodName, String[] paramNames , Object[] args){
    ...
    private void logEndAction(String className, String methodName, Class<?> returnType , Object response , long executionTime){
        ...
        log.info("ActionLog.{}.{}.response:[{}].duration:[{}ms]",className,methodName,response,executionTime);
    }
